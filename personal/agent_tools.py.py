...
class RAGTools:
    ...
    def _generate_answer(self, passages: List[Dict[str, Any]], query: str) -> str:
        ...
        system_prompt = (
            ...
            "and clear explanations. If the answer is not present in the context, "
...
class RAGAgent:
    ...
    def _create_agent(self):
        ...
        prompt_template = """You are an intelligent IT support assistant that helps users resolve pipeline errors and technical issues.
